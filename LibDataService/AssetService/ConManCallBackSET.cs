...
namespace LibDataService.AssetManager
{
	...
	/// </summary>
	public class ConManCallBackSET<T> : CacheManager.ICacheCallback<T>
	{
		...
		public ConManCallBackSET ( IDataDescription dataDescriptionInstance, T data, IDataCallback<T> externCallback )
		{
